...
const employees = ['王郡江', '杨有淇', '张玉莲', '王涛', '王清月'];
const operationGroup = ['王郡江', '杨有淇', '张玉莲', '王涛', '王清月']; // 运营组5人（彭润梅已离职）
```

**注意**: 曾衡、彭润梅已离职,原美工组的王涛、王清月已全部加入运营组,美工组已移除。

### 公司大扫除系统(21人)
```javascript
// 位置:销售部大扫除安排表.html 约第834-839行
