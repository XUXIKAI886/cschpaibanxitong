...
3. **销售部大扫除安排表.html** - 公司清洁任务分配系统(22人,20任务)
...
### 运营部排班系统(6人)
```javascript
// 位置:排班表系统.html 约第981-983行
const employees = ['王郡江', '杨有淇', '张玉莲', '彭润梅', '王涛', '王清月'];
const operationGroup = ['王郡江', '杨有淇', '张玉莲', '彭润梅', '王涛', '王清月']; // 运营组6人（原美工王涛、王清月已加入）
```

**注意**: 曾衡已离职,原美工组的王涛、王清月已全部加入运营组,美工组已移除。

### 公司大扫除系统(22人)
```javascript
// 位置:销售部大扫除安排表.html 约第833-839行
...
**注意**:已删除离职人员"孙文龙"、"朱春玖"、"魏祯宇"、"田昊"、"曾衡",已添加新员工"左冉",当前为22人配置。
...
### 修改大扫除系统人员
1. 打开 `销售部大扫除安排表.html`
2. 找到约第833-839行的 `companyEmployees` 数组
3. 添加或删除人员姓名
