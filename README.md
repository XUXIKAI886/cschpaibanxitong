...
### 📋 系统概述
公司大扫除安排表是一个专门为公司设计的清洁任务分配管理系统。通过直观的右键菜单操作，将公司23名员工分配到7个不同区域的具体清洁任务中，确保办公环境的整洁有序。系统特别优化了Tauri环境的兼容性。
...
**总计：17个具体任务，需要17名人员参与（总计23名员工，充足可灵活分配）**

#### 🎯 任务特点
- **任务明确**：每个任务都有详细的工作内容说明
- **人员匹配**：任务数量与公司人员数量匹配（23人17任务，人员充足可灵活分配）
...
### Q11: 大扫除系统支持多少人员？
**A:** 当前配置为23名公司员工，17个具体清洁任务。可以通过修改JavaScript中的`companyEmployees`数组来调整人员名单。
