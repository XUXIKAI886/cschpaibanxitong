...
一个基于HTML5的智能员工排班管理系统，支持拖拽操作、智能排班算法和多种排班规则。包含运营部排班系统和销售部大扫除安排表两个核心模块。
...
### 🧹 销售部大扫除安排表
专门为销售部设计的清洁任务分配系统，通过拖拽操作将销售部人员分配到具体的清洁任务中，确保办公环境的整洁有序。
...
### 📋 系统概述
销售部大扫除安排表是一个专门为销售部设计的清洁任务分配管理系统。通过直观的拖拽操作，将销售部11名员工分配到6个不同区域的具体清洁任务中，确保办公环境的整洁有序。
...
|---------|---------|---------|-------------|
| **大厅** | 3个任务 | 3人 | ① 擦桌子+擦证书展示区+隔断<br>② 拖地<br>③ 扫地 |
| **总经理室** | 3个任务 | 3人 | ① 清洗茶具<br>② 擦桌子+扫地<br>③ 拖地 |
| **会议室** | 2个任务 | 2人 | ① 擦桌子+扫地<br>② 拖地 |
| **客服部** | 1个任务 | 1人 | ① 扫地+拖地 |
| **杂物区** | 1个任务 | 1人 | ① 擦洗微波炉转盘+擦饭桌+清洗洗手池+整理台面 |
| **其他** | 2个任务 | 2人 | ① 绿植浇水+换垃圾袋<br>② 前台区域大扫除（固定：吴思湘） |

**总计：12个具体任务，需要12名人员参与**

#### 🎯 任务特点
- **任务明确**：每个任务都有详细的工作内容说明
- **人员匹配**：任务数量与销售部人员数量匹配（16人12任务，人员充足可灵活分配）
- **区域覆盖**：涵盖办公区域的所有重要清洁点，包括前台区域
- **工作均衡**：不同区域的工作量相对平衡
- **固定分配**：前台区域大扫除固定分配给吴思湘，确保专人负责
...
### Q11: 销售部系统支持多少人员？
**A:** 当前配置为16名销售部员工，12个具体清洁任务。可以通过修改JavaScript中的`salesEmployees`数组来调整人员名单。
...
### Q19: 返回首页按钮在哪里？
**A:** 在运营部排班系统和销售部大扫除系统的右上角都有"返回首页"按钮，点击即可回到导航首页。
